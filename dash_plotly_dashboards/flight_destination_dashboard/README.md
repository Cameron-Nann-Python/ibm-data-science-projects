...
![Flight Destination Dashboard](https://github.com/Cameron-Nann-Python/ibm-data-science-projects/blob/main/dash_plotly_dashboards/flight_destination_dashboard/screenshots/flight_destination_desktop.png)
...
## Files Included
- `flight_destination.py`: Python file containing Dash app and IBM dataset.
- `requirements.txt`: Required Python libraries.
- `flight_destination_desktop.png`: Screenshot of Dash app on desktop.
